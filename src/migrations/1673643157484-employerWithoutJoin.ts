...
export class employerWithoutJoin1673643157484 implements MigrationInterface {
    name = 'employerWithoutJoin1673643157484'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user_employer" DROP CONSTRAINT "REL_65f0cb54567ad8ed59a3bacb98"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user_employer" ADD CONSTRAINT "REL_65f0cb54567ad8ed59a3bacb98" UNIQUE ("addressId")`);
