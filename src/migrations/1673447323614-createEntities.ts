...
export class createEntities1673447323614 implements MigrationInterface {
    name = 'createEntities1673447323614'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "rating" ("id" uuid NOT NULL, "recomendation" character varying NOT NULL, "note" character varying NOT NULL, CONSTRAINT "PK_ecda8ad32645327e4765b43649e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "address" ("id" uuid NOT NULL, "street" character varying NOT NULL, "zipCode" character varying NOT NULL, "number" character varying NOT NULL, "city" character varying NOT NULL, "state" character varying NOT NULL, CONSTRAINT "PK_d92de1f82754668b5f5f5dd4fd5" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "user_employer" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "is_hired" boolean NOT NULL, "avatar_img" character varying NOT NULL, "gender" character varying, "location" character varying, "addressId" uuid, CONSTRAINT "REL_65f0cb54567ad8ed59a3bacb98" UNIQUE ("addressId"), CONSTRAINT "PK_3f4b66f3b18d4c8d5bd4ff41b2e" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "user_hired" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "is_hired" boolean NOT NULL, "avatar_img" character varying NOT NULL, "gender" character varying, "location" character varying, "addressId" uuid, CONSTRAINT "REL_8cad5d8c19d83e5f6997272c2c" UNIQUE ("addressId"), CONSTRAINT "PK_c152c63a5d9dee96c681992d539" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "employer_proposal_hired" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying NOT NULL, "description" character varying NOT NULL, "status" character varying NOT NULL, "employerId" uuid, "hiredId" uuid, "ratingId" uuid, CONSTRAINT "REL_26052233e9db13f4c826790944" UNIQUE ("ratingId"), CONSTRAINT "PK_639510d0f500e0c7a96d5d2455b" PRIMARY KEY ("id"))`);
